# -------------------------------------------------------------------------
# OBJECT:   packages
# PURPOSE:  Vectors of commonly utilized R packages
...
packages.tidyverse <- c(
  ...
  "purrr",              # functional programming / elegant loops
...
packages <- c(
  ...
  "mosaic",             # statistics functions
  "nortest",            # Anderson-Darling test of normality
  "openxlsx",           # reading and writing from and to Excel
  "plotly",             # used for 3-dimensional plots
  "random",             # connects with the Random.org API
