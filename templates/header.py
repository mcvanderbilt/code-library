...
Dependencies: <package>=x.y.z, ...  or  None
License:      See LICENSE — free for academic/personal use with attribution
"""
# The header is the module docstring (must be the first statement in the file,
# after any shebang or encoding line) so help(module) displays it.
